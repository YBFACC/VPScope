      ...
      {showGrid ? (
        <>
          {Array.from({ length: 7 }, (_, index) => {
            ...
            return <line key={`v-${index}`} x1={x} x2={x} y1="0" y2={gridBottom} stroke="var(--color-chart-grid)" strokeWidth="1" opacity="0.26" />;
          })}
          ...
          <line x1="0" x2={width} y1={gridBottom} y2={gridBottom} stroke="var(--color-chart-grid)" strokeWidth="1" />
        </>
      ) : null}
