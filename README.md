...
MVP 明确不做破坏性远程操作，例如 kill、restart、delete、service control；当前已支持只读 Docker 日志查看，更完整的容器管理、Kubernetes、GPU、历史数据库和复杂告警系统仍不属于当前范围。
...
- Docker 日志工作区：从已保存主机打开只读 Docker logs overlay，查看全部容器、最近日志、tail 大小切换、手动刷新和可选轮询刷新。
